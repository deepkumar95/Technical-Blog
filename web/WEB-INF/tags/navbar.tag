<nav class="navbar navbar-expand-lg navbar-dark primary-background">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" href="login.jsp">Login <span class="fa fa-user-circle-o fa-1x"></span></a>
      </li>
      <li class="nav-item">
          <a class="nav-link" href="registration.jsp">Register <span class="fa fa-user-plus fa-1x"></span></a>
      </li>
    </ul>
